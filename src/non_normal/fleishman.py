...
class Fleishman:
    ...
    def fl_ic(self):
        ...
        b0 = 0.95357 - 0.05679 * self.ekurt + 0.03520 * \
            self.skew**2 + 0.00133 * self.ekurt**2
    ...
    def gen_field(self):
        ...
        try:
            if self.ekurt < ekurt_thresh:
                ...
                self.field_stats = {'mean': mean,
                                    'var': var, 'skew': skew, 'ekurt': ekurt}
